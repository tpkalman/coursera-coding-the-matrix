...
## Task 6
first_five_pows_two = { 2**p for p in {0,1,2,3,4} }
...
three_digits_set = { x for x in digits if base**x < 1000 }
...
## Task 14
S = {-4, -2, 1, 2, 5, 0}
zero_sum_list = [ (a,b,c) for a in S for b in S for c in S if sum((a,b,c)) == 0 ] 

## Task 15
exclude_zero_list = [ (a,b,c) for a in S for b in S for c in S if sum((a,b,c)) == 0 ] 
