...
def login_prompt():
    return 'wycleffsean@gmail.com'#input('Login email address: ')


def password_prompt():
    return 'nnv5BpPfBy' #input("One-time password from the assignment page (NOT your own account's password): ")
